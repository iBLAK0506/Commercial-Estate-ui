  ...
  return (
    <div className="aboutPage">
      <div className="section">
        ...
        <img src="/images/about.jpg" alt="About iBLAK" />
      </div>
      ...
      <div className="section">
        ...
        <p>
          ...
          knowledge they need to make informed real estate decisions. We strive
          to offer a seamless and stress-free experience, whether you are
          finding your dream home, a strategic investment, or the perfect
          tenant.
        </p>
      ...
      <div className="section">
        ...
        <ul>
          ...
          <li>
            ...
            everything we do. We listen to your needs and tailor our services to
        ...
        <img src="/images/why-choose.jpg" alt="Why Choose Us" />
      </div>
    </div>
  );
}
